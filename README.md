...
- `MachineLearning.pdf` → `MachineLearning_summarized.pdf`
- `MachineLearning.pdf` → `MachineLearning_summarized.docx`
- `MachineLearning.pdf` → `MachineLearning_summarized.txt`
